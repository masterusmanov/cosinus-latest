<script setup>
  import HomeviewOne from '../components/Homeviews/HomeviewOne.vue';
...
<template>
  <section id="main" class="relative">  
    <div class="container mx-auto">
      <HomeviewOne/>
      <SpecEffect/>
      <p class="text-[21px] text-center text-white font-[500] mt-[120px] md:mt-[176px] lg:mt-[260px] font-sans">Companies growing with us</p>
      <HomeviewOnes class=""/>
      <HomeviewTwo class=""/>
      <HomeviewThree/>
      <HomeviewFour/>
