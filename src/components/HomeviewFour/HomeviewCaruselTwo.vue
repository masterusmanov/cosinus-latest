      ...
      <div class="items ">
        <div class="w-[350px] h-[274px] mx-auto rounded-[16px] bg-gradient-to-t from-[#242B3D] to-[#999FB0] p-0.5">
            <div class="h-[269px] rounded-[16px] bg-[#171B3F] opacity-90">
                <div class="grid gap-4 pl-[32px] pt-[32px]">
                    <svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 48 48" fill="none" class="">
                        <circle cx="24" cy="24" r="23" stroke="url(#paint0_linear_421_2359)" stroke-width="2"/>
                        <defs>
                            <linearGradient id="paint0_linear_421_2359" x1="52.2" y1="2.00003" x2="-1.77765" y2="2.72046" gradientUnits="userSpaceOnUse">
