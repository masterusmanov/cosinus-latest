<template>
    <div class="text-white  mt-[120px]">
        <h2 class="text-[27px] md:text-[36px] lg:text-[61px] font-[900] font-sans text-center md:w-[70%] lg:w-[70%] mx-auto p-5 lg:p-0 mt-[40px] md:mt-0">Biz bilan ishlashga tayyormisiz?</h2>
